<%@ Page Title="" Language="C#" MasterPageFile="~/YoneticiPanel/YoneticiMasterPage.Master" AutoEventWireup="true" CodeBehind="MakaleEkle.aspx.cs" Inherits="OnebeBlogApp.YoneticiPanel.MakaleEkle" ValidateRequest="false" %>
    ...
    <div class="formTasiyici">
        ...
        <div class="formIcerik">
            <asp:Panel ID="pnl_basarili" runat="server" CssClass="basariliMesaj" Visible="false">
                <label>Makale başarıyla Eklendi</label>
            </asp:Panel>
            ...
            <div class="bolunmusIcerik">
                <div class="kolon">
                    ...
                    <div class="satir">
                        <asp:Button ID="btn_ekle" runat="server" Text="Makale Ekle" OnClick="btn_ekle_Click" CssClass="button" />
                    </div>
                </div>
